namespace gpro_desktop_windows.Forms
{
  partial class CrearProyectoForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "CrearProyectoForm";
      this.ShowIcon = false;
      this.Text = "Crear Proyecto";
      this.Load += new System.EventHandler(this.CrearProyectoForm_Load);
    ...
    private MetroFramework.Controls.MetroTextBox textBoxTitulo;
    private MetroFramework.Controls.MetroTextBox textBoxDescProyecto;
  }
}